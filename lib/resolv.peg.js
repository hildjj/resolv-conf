...
function peg$parse(input, options) {
  ...
  var peg$e14 = peg$classExpectation([["0", "9"], ["a", "f"], ["A", "F"], ":", "."], false, false);
  var peg$e15 = peg$literalExpectation("::", false);
  var peg$e16 = peg$literalExpectation(".", false);
  var peg$e17 = peg$classExpectation([["0", "9"], ["a", "f"], ":"], false, true);
  ...
  var peg$e22 = peg$otherExpectation("optional whitespace");
  var peg$e23 = peg$classExpectation([" ", "\t"], false, false);
  var peg$e24 = peg$otherExpectation("whitespace");
  var peg$e25 = peg$otherExpectation("EOL");
  ...
  var peg$f11 = function(name, val) { return {
    errors: {text: text(), location: location()}}
  };
  var peg$f12 = function(addr) { return net.isIP(addr) };
  var peg$f13 = function(v6, v4) { return net.isIPv6(`${v6}::${v4}`) };
  var peg$f14 = function(v6, v4) {
      const v6addr = `${v6}::${v4}`
      ports[v6addr] = ports[v4];
      delete ports[v4];
      return v6addr;
    };
  var peg$f15 = function(addr, port) {
      ports[addr] = port;
      return addr;
    };
  var peg$f16 = function(addr) { return net.isIPv6(addr) };
  var peg$f17 = function(addr, port) {
      ports[addr] = port;
      return addr
    };
  var peg$f18 = function(n) { return (parseInt(n, 10) < 256) };
