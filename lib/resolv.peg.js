...
function peg$parse(input, options) {
  ...
  var peg$f10 = function(name, val) { return {
    errors: {text: text(), location: location()}}
  };
  var peg$f11 = function(addr) { return net.isIP(addr) };
  var peg$f12 = function(v6, v4) { return net.isIPv6(`${v6}::${v4}`) };
  var peg$f13 = function(v6, v4) {
      const v6addr = `${v6}::${v4}`
      ports[v6addr] = ports[v4];
      delete ports[v4];
      return v6addr;
    };
  var peg$f14 = function(addr, port) {
      ports[addr] = port;
      return addr;
    };
  var peg$f15 = function(addr) { return net.isIPv6(addr) };
  var peg$f16 = function(addr, port) {
      ports[addr] = port;
      return addr
    };
  var peg$f17 = function(n) { return (parseInt(n, 10) < 256) };
